...
def inject_openai_api():
    ...
    if IS_LEGACY_OPENAI:
        ...
        openai.azure_endpoint = os.environ.get("AZURE_OPENAI_ENDPOINT", openai.azure_endpoint)
        openai.azure_ad_token = os.environ.get("AZURE_OPENAI_AD_TOKEN", openai.azure_ad_token)
